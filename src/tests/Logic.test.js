...
import {solveEquation, isValid, solve} from '../logic/services/EquationService';
import Equation from '../logic/models/Equation';
import operationMethod from '../logic/models/OperationMethod';

//TO RUN: yarn test

//Generating some random valid equations
const eq_2_plus_3 = new Equation(2, [{operationMethod: operationMethod.ADDITION, number: 3}])
const eq_8_plus_3_mul_2 = new Equation(8, [{
    operationMethod: operationMethod.ADDITION,
    number: 3
}, {operationMethod: operationMethod.MULTIPLICATION, number: 2}])
const eq_4_plus_6_mul_3_mul_4 = new Equation(4, [{
    operationMethod: operationMethod.ADDITION,
    number: 6
}, {operationMethod: operationMethod.MULTIPLICATION, number: 3}, {
    operationMethod: operationMethod.MULTIPLICATION,
    number: 4
}])
const eq_8_min_3 = new Equation(8, [{operationMethod: operationMethod.SUBSTITUTION, number: 3}])
const eq_6_mul_2_div_3 = new Equation(6, [{
    operationMethod: operationMethod.MULTIPLICATION,
    number: 2
}, {operationMethod: operationMethod.DIVISION, number: 3}])
const eq_1_plus_5_plus_9 = new Equation(1, [{
    operationMethod: operationMethod.ADDITION,
    number: 5
}, {operationMethod: operationMethod.ADDITION, number: 9}])
const eq_10_min_1_plus_5_mul_9 = new Equation(10, [{
    operationMethod: operationMethod.SUBSTITUTION,
    number: 1
}, {operationMethod: operationMethod.ADDITION, number: 5}, {
    operationMethod: operationMethod.MULTIPLICATION,
    number: 9
}])
...
const eq_8_minus_3_div_2 = new Equation(8, [{
    operationMethod: operationMethod.SUBSTITUTION,
    number: 3
}, {operationMethod: operationMethod.DIVISION, number: 2}])
const eq_4_min_6_div_3_div_4 = new Equation(4, [{
    operationMethod: operationMethod.SUBSTITUTION,
    number: 6
}, {operationMethod: operationMethod.DIVISION, number: 3}, {operationMethod: operationMethod.DIVISION, number: 4}])
const eq_8_div_3 = new Equation(8, [{operationMethod: operationMethod.DIVISION, number: 3}])
const eq_6_div_2_div_4 = new Equation(6, [{
    operationMethod: operationMethod.DIVISION,
    number: 2
}, {operationMethod: operationMethod.DIVISION, number: 4}])
const eq_1_minus_5_minus_9 = new Equation(1, [{
    operationMethod: operationMethod.SUBSTITUTION,
    number: 5
}, {operationMethod: operationMethod.SUBSTITUTION, number: 9}])
const eq_10_min_1_min_1_mul_9 = new Equation(10, [{
    operationMethod: operationMethod.SUBSTITUTION,
    number: 1
}, {operationMethod: operationMethod.SUBSTITUTION, number: 1}, {
    operationMethod: operationMethod.MULTIPLICATION,
    number: 9
}])
const eq_10_div_8_mul_8 = new Equation(10, [{
    operationMethod: operationMethod.DIVISION,
    number: 8
}, {operationMethod: operationMethod.MULTIPLICATION, number: 8}])
const eq_6_min_3_mul_10 = new Equation(6, [{
    operationMethod: operationMethod.SUBSTITUTION,
    number: 3
}, {operationMethod: operationMethod.MULTIPLICATION, number: 10}])
...
describe('App logic', () => {
    ...
    it('solves equations correctly', () => {
        ...
        expect(solveEquation(eq_6_min_3_mul_10)).toBe(-24)
    })
    ...
    it('detects unvalid equations correctly', () => {
        ...
        expect(isValid(eq_10_div_8_mul_8)).toBe(false)
        expect(isValid(eq_6_min_3_mul_10)).toBe(false)
    ...
    it('detects correctly if equation has more than 2 numbers', () => {
        expect((eq_2_plus_3.hasMoreThanTwoNumbers())).toBe(false);
        expect((eq_6_mul_2_div_3.hasMoreThanTwoNumbers())).toBe(true);
        expect((eq_4_plus_6_mul_3_mul_4.hasMoreThanTwoNumbers())).toBe(true);
